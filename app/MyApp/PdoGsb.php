...
*/
	...
	public function getInfosComptable($login, $mdp){
		$req = "select comptable.prenom as prenom, comptable.nom as nom from comptable 
	...
	// voir cr 
public function getIdVisiteurcr(){
		$req = "select idVisiteur as id, visiteur.nom as nom, visiteur.prenom as prenom 
		from fichefrais INNER JOIN visiteur ON fichefrais.idVisiteur=visiteur.id where idEtat='CR';";
		$rs =$this->monPdo->query($req);
		$ligne = $rs->fetchAll();
		return $ligne;
	}
	//voir cr d'un utilisateur
	public function getCr($etat){
		$req = "select * from fichefrais where idEtat ='CR' and login='$idVisiteur'";
		$rs =$this->monPdo->query($req);
			$ligne = $rs->fetchAll();
			return $ligne;
